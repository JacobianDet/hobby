...
int main () {
  ...
  system("dir /b *.png > img_name.txt"); //Writing the names of all the images in the new2 file
  ...
  if (myfile.is_open())
  {
    ...
    {
      cout << line << '\n';
      outfile << "<div class=\"box\"><div class=\"boxInner\"><a href=\"editing/images/"<<line<<"\" class=\"thumbnail\"><img src=\"editing/images/"<<line<<"\" alt=\""<<line<<"\"></a></div> </div>\n";	//Applying html syntax to file names
    }
    myfile.close();
  }
